...
from app.crypto import issue_receipt_jwt
...
# Lock for non-PostgreSQL thread serialization during concurrent test executions
_LOCAL_WEBHOOK_LOCK = threading.RLock()
    ...
    try:
        ...
        if event_type == "payment.captured":
            ...
            receipt = PaymentReceipt(
                ...
                intent_hash="",  # Populated from stored mandate_jwt if needed
